        ...
        <div class="container">
            <div class="row" style="margin-bottom: 30px">
                ...
                <button type="button" class="btn btn-success prod-btn" style="pointer-events: none">Camera
                    IP</button>
                <button type="button" class="btn btn-info prod-btn" data-url="<?= base_url()?>index.php/Home/panel">Flat
                    Panel Display IP</button>
                <button type="button" class="btn btn-info prod-btn"
                    data-url="<?= base_url()?>index.php/Home/sensor">Image Sensor IP</button>
                <button type="button" class="btn btn-info prod-btn"
                    data-url="<?= base_url()?>index.php/Home/interface">High Speed Interface IP</button>
                <button type="button" class="btn btn-info prod-btn"
                    data-url="<?= base_url()?>index.php/Home/ic">Application Specific IC</button>
                <button type="button" class="btn btn-info prod-btn" data-url="<?= base_url()?>index.php/Home/board">Chip
                    Board</button>
